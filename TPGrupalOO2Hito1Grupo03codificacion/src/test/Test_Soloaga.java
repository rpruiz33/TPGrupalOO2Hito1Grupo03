    ...
    public static void main(String[] args) {
        try {
            ...
            long[] idsCaj = {
            		...
            		cajeroABM.agregar("Martin", "Gomez", "685551666", LocalDate.of(1985, 9, 3), LocalDate.of(2022, 3, 15), 470000.0, "Tarde", 2, 18000.0),
            		cajeroABM.agregar("Roberto", "Sanchez", "312999888", LocalDate.of(1988, 11, 5), LocalDate.of(2021, 5, 10), 500000.0, "Mañana", 3, 20000.0),
            		cajeroABM.agregar("Valentina", "Torres", "392221111", LocalDate.of(1992, 6, 18), LocalDate.of(2023, 8, 5), 460000.0, "Noche", 1, 15000.0),
            ...
            System.out.println("\n--- PRUEBA SUBTOTAL ITEMS PEDIDO Y TOTAL PLATO ---");
