...
public abstract class UnidadVenta {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codigo, nombreComercial, superficieM2, pedidos, platosOfrecidos, staffPuesto, responsable);
    }

    @Override
    public String toString() {
        return "UnidadVenta{" + "id=" + id + ", codigo='" + codigo + '\'' + ", nombreComercial='" + nombreComercial + '\'' +
                ", superficieM2=" + superficieM2 + ", pedidos=" + pedidos + ", platosOfrecidos=" + platosOfrecidos +
                ", staffPuesto=" + staffPuesto + ", responsable=" + responsable + '}';
    }
}